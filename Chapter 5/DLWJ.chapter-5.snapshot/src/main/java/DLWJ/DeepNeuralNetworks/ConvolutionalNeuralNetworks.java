...
public class ConvolutionalNeuralNetworks {
    ...
    public ConvolutionalNeuralNetworks(int[] imageSize, int channel, int[] nKernels, int[][] kernelSizes, int[][] poolSizes,
                                       int nHidden, int nOut, Random rng, String activation) {
        if (rng == null)
            rng = new Random(1234);
